...
sampobs <- BearSubsample(sampobs, "random", 450)
...
#' Write this file out
write.csv(sampobs3, file="../data/SubsamplingData/TempCsv.csv", row.names=FALSE)  

#' Apply the capture history transformation necessary for secr models
BearSumFunc(data="../data/SubsamplingData/TempCsv.csv", summary = FALSE, output="../data/SubsamplingData/TempCsv2.csv")

#' Run the model fitting and storage function.
BearModelFit(output = "SimpleRandom")
